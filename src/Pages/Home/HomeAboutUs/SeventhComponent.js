...
const SeventhComponent = () => {
 ...
 <Container>
      <Row style={{color:'white',padding:'150px 0'}} >
        ...
        <Col ><Button style={{padding:'10px 30px',borderRadius:'30px,',backgroundColor:'red'}} ><Link to='/ContactUs'style={{textDecoration:'none', color:'white'}}>Contact Us</Link></Button></Col>
      </Row>
    </Container>
    </div>
  )
