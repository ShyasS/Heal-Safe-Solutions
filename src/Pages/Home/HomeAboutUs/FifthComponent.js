...
//                         <h2 class=" p-5 text-center" style={{ color: 'white' }}>WHY CHOOSE US?</h2>
//                         <h2 class=" p-2 text-center" style={{ color: 'white' }}>People choose us for our quality craftsmanship!</h2>                   
//                         </div>  
//                             <div className='col-lg-3 col-xl-2 col-md-3 my-3 mx-auto' >
...
//                                 </Card>
//                                 </div>
//                                 <div  className='col-lg-4 col-md-4 my-3 mx-auto'  >
            ...
            <Container fluid >
                <Row>
                    {/* <Col lg={5} > */}
                        ...
                        <h2 class=" p-2 text-center" style={{ color: 'white' }}>People choose us for our quality craftsmanship!</h2>                   
                        {/* </Col> */}
                            <Row xs={1} sm={3} xl={3} lg={3} md={2} className="d-flex justify-content-center grid gap-3 my-3">
                                <Card id='HomeFifthCardComp' border="primary" >
                                    <Card.Img variant="top" src={require('../../../Assests/Images/Home-FifthLeftImg1.png')} style={{ height: '60px', width: '60px', margin: ' 10px 50px' }} />
                                    <Card.Body>
                                        <Card.Title style={{ margin: '20px 0' }}><h5>Quick & Easy</h5></Card.Title>
